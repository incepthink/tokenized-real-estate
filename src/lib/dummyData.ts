...
export const PROPERTIES: Property[] = [
  {
    ...
    pinned: true,
    contractAddress: "0xD9AF49Fa0494a43Fd7FF9d7f37f02edFbf634Ae7",
  },
  {
    id: "beta",
    name: "Property Beta",
    ...
    pinned: true,
    contractAddress: "0x5D2feF52a1fCabe0F23ce2CE0512028Ab566Cd91",
  },
  {
    id: "meridian",
  ...
  {
    id: "harbor",
    name: "Harbor View Commercial Tower",
    city: "Miami",
    type: "Commercial",
    status: "Active",
    tokenSymbol: "HVCX",
...
export const TRANSACTION_HISTORY: Transaction[] = [
  {
    ...
    propertyId: "meridian",
    tokenSymbol: "MRDX",
    propertyName: "The Meridian Residences",
    amount: 5,
    pricePerToken: 43.5,
    totalValue: 217.5,
    wallet: wallets[0],
  ...
  },
  {
    ...
    propertyId: "harbor",
    tokenSymbol: "HVCX",
    propertyName: "Harbor View Commercial Tower",
    amount: 10,
    pricePerToken: 13.0,
    totalValue: 130.0,
    wallet: wallets[1],
  ...
  },
  {
    ...
    propertyId: "austin",
    tokenSymbol: "DAPL",
    propertyName: "Downtown Austin Plaza",
    amount: 3,
    pricePerToken: 21.5,
    totalValue: 64.5,
    wallet: wallets[2],
  ...
  },
  {
    ...
    propertyId: "brooklyn",
    tokenSymbol: "BCLX",
    propertyName: "Brooklyn Creative Lofts",
    amount: 8,
    pricePerToken: 17.5,
    totalValue: 140.0,
    wallet: wallets[0],
